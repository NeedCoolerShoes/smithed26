...
scoreboard objectives add ncrs.booth.summon.hangers.assign dummy
...
scoreboard players set $370 ncrs.constants 370
scoreboard players set $500 ncrs.constants 500
scoreboard players set $1200 ncrs.constants 1200